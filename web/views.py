...
def about_us(requset):
    ...
    context = {"client": client, "team": team}
...
def contact(request):
    ...
    if request.method == "POST":
        ...
        context = {"is_contact": True, "forms": forms}
...
def blog(request):
    ...
    print(blog_list)
    context = {"blog_banner": blog_banner, "blog_list": blog_list}
...
def portfolio(request):
    ...
    context = {"is_product": True, "category": category, "portfolio": portfolio}
...
def careers(request):
    ...
    if "search" in request.GET:
        ...
        context = {"is_career": True, "jobs": jobs}
...
def design_digital_media(request):
    ...
    context = {"is_product": True, "category_digital_media": category_digital_media, "digital_media": digital_media}
